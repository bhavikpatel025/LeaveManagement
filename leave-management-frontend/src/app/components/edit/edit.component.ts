            ...
            <div class="card-body p-4">
              ...
              >
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input
                      ...
                      [class.is-invalid]="
                        f['emailAddress'].invalid && f['emailAddress'].touched
                      "
                    />
                    <div
                      class="invalid-feedback"
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input
                      ...
                      [class.is-invalid]="
                        f['contactNo'].invalid && f['contactNo'].touched
                      "
                    />
                    <div
                      class="invalid-feedback"
                      *ngIf="f['contactNo'].invalid && f['contactNo'].touched"
                    >
                ...
                <div class="row mb-4">
                  <div class="col-md-6 mb-3">
                    ...
                    <input
                      ...
                      [class.is-invalid]="
                        f['department'].invalid && f['department'].touched
                      "
                    />
                    <div
                      class="invalid-feedback"
                      *ngIf="f['department'].invalid && f['department'].touched"
                    >
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input
                      ...
                      [class.is-invalid]="
                        f['designation'].invalid && f['designation'].touched
                      "
                    />
                    <div
                      class="invalid-feedback"
                ...
                <div class="row mb-4" formArrayName="leaveBalances">
                  <div
                    *ngFor="
                      let balance of leaveBalancesArray.controls;
                      let i = index
                    "
                    class="col-md-4 mb-3"
                    [formGroupName]="i"
                    ...
                    <div class="card border-warning">
                      <div class="card-body">
                        ...
                        <input
                          ...
                          max="365"
                          [class.is-invalid]="
                            balance.get('balance')?.invalid &&
                            balance.get('balance')?.touched
                          "
                        />
                        <div
                          class="invalid-feedback"
                        ...
                        >
                          <div
                            *ngIf="balance.get('balance')?.errors?.['required']"
                          >
                            Balance is required
                          </div>
                          <div *ngIf="balance.get('balance')?.errors?.['min']">
                            Balance cannot be negative
                          </div>
                          <div *ngIf="balance.get('balance')?.errors?.['max']">
                            Balance cannot exceed 365 days
                          </div>
                        </div>
                      </div>
                    </div>
...
export class EditEmployeeComponent implements OnInit {
  ...
  initializeLeaveBalances(): void {
    ...
    this.leaveTypes.forEach((leaveType) => {
      const existingBalance = this.employee?.leaveBalances.find(
        (b) => b.leaveTypeId === leaveType.id
      );

      leaveBalancesArray.push(
  ...
  get leaveBalancesArray() {
    return this.editForm.get('leaveBalances') as FormArray;
  }
