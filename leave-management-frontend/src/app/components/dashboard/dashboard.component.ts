...
@Component({
  ...
  template: `
    <div class="container-fluid py-4">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div *ngIf="recentLeaves.length === 0" class="empty-state">
                  ...
                  <p class="text-muted">
                    Leave requests will appear here once employees start
                    applying.
                  </p>
                </div>
      ...
      <!-- Employee Dashboard -->
      <div
        *ngIf="!loading && authService.isEmployee"
              ...
              <div class="card-body d-flex flex-column">
                ...
                <div class="mt-4 p-3 bg-light rounded">
                  <small class="text-muted">
                    ...
                    Remember: Leave requests should be submitted at least 3 days
                    in advance.
                  </small>
                </div>
              </div>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              >
                <h5 class="card-title mb-0">
                  <i class="bi bi-calendar-event me-2"></i>My Recent Leave
                  Applications
                </h5>
                <a
                  routerLink="/my-leaves"
