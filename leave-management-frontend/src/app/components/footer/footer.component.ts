      ...
      <div class="container py-5">
        <div class="row">
          ...
          <div class="col-md-4 mb-4">
            ...
            <ul class="list-unstyled small">
              ...
              <li>
                <a routerLink="/apply-leave" class="footer-link">Apply Leave</a>
              </li>
              <li>
                <a routerLink="/my-leaves" class="footer-link">My Leaves</a>
              </li>
              <li>
          ...
          <div class="col-md-4 mb-4">
            ...
            <p class="text-muted small mb-1">
              ...
              <a href="mailto:pb3721700@gmail.com" class="footer-link">{{
                'pb3721700@gmail.com'
              }}</a>
            </p>
            <p class="text-muted small mb-1">
        ...
        >
          ...
          <div class="mt-2 mt-md-0 footer-social">
            ...
            ></a>
            <a
              href="https://www.linkedin.com/in/bhavik-patel-217a402a5?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
