                ...
                <div class="card h-100 border-primary employee-card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="leave-balances">
                      ...
                      <div class="mt-2">
                        <div
                          *ngIf="employee.leaveBalances.length === 0"
                          class="text-muted small"
                        >
                          No leave balances set
                        </div>
                        <div
                          *ngFor="let balance of employee.leaveBalances"
                          class="balance-row"
                        >
                          <span class="small"
                            >{{ balance.leaveTypeName }}:</span
                          >
                        ...
                        <div class="balance-row fw-bold">
                          ...
                          <span class="badge bg-success ms-auto"
                            >{{ getTotalLeaveBalance(employee) }} days</span
                          >
                        </div>
                      </div>
                    </div>
...
export class ManageEmployeesComponent implements OnInit {
  ...
  getTotalLeaveBalance(employee: User): number {
    return employee.leaveBalances.reduce(
