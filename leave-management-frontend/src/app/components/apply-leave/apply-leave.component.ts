                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <select
                      ...
                      [class.is-invalid]="
                        f['leaveTypeId'].invalid && f['leaveTypeId'].touched
                      "
                    >
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input
                      ...
                      [min]="minDate"
                      [class.is-invalid]="
                        (f['startDate'].invalid && f['startDate'].touched) ||
                        applyLeaveForm.hasError('pastDate') ||
                        applyLeaveForm.hasError('invalidDateRange')
                      "
                    />
                    <div
                      class="invalid-feedback"
                    ...
                    <div
                      class="invalid-feedback"
                      *ngIf="applyLeaveForm.hasError('pastDate')"
                    >
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input
                      ...
                      [class.is-invalid]="
                        (f['endDate'].invalid && f['endDate'].touched) ||
                        applyLeaveForm.hasError('invalidDateRange')
                      "
                    />
                    <div
                    ...
                    <div
                      class="invalid-feedback"
                      *ngIf="applyLeaveForm.hasError('invalidDateRange')"
                    >
                  ...
                  >
                    <div class="alert alert-info">
                      <div class="d-flex align-items-center">
                        ...
                        <span class="ms-auto">
                          <span
                            *ngIf="getLeaveDays() <= getAvailableBalance()"
                            class="text-success"
                          >
                  ...
                  <div class="col-12 mb-4">
                    ...
                    <textarea
                      ...
                      [class.is-invalid]="
                        f['reasonForLeave'].invalid &&
                        f['reasonForLeave'].touched
                      "
                    ...
                    <div
                      ...
                      *ngIf="
                      ...
                      "
                    >
                      <div *ngIf="f['reasonForLeave'].errors?.['required']">
                        Reason is required
                      </div>
                      <div *ngIf="f['reasonForLeave'].errors?.['maxlength']">
                        Reason cannot exceed 1000 characters
                      </div>
                    </div>
                    <div class="form-text">
                      {{ f['reasonForLeave'].value?.length || 0 }}/1000
                      characters
                    </div>
                  </div>
                  ...
                  <div class="col-12">
                    <div class="d-flex justify-content-end gap-3">
                      ...
                      <button
                        ...
                        [disabled]="
                          loading ||
                          applyLeaveForm.invalid ||
                          getLeaveDays() > getAvailableBalance()
                        "
                      >
                        <span
                          *ngIf="loading"
